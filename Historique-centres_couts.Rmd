...
On remarque qu'on a bien ajouté les 12 centres de couts manquants
...
```{r}
length(intersect(centres_couts2020$Code, centres_coutsv1$Code)) # Nombre de programmes en commun
length(setdiff(centres_couts2020$Code, centres_coutsv1$Code)) # Nombre de programmes différents
```
...
for (col in colonnes) {
  ...
  colonne_cible <- sub("2019$|v1$", "", col)
  
  # Remplissez les valeurs manquantes dans la colonne cible en utilisant les valeurs correspondantes
  centres_coutsv1[[colonne_cible]] <- ifelse(is.na(centres_coutsv2[[paste0(colonne_cible, "2024")]]),
                                 centres_coutsv2[[paste0(colonne_cible, "2022")]],
                                 centres_coutsv2[[paste0(colonne_cible, "2024")]])
}
