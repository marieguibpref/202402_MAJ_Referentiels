...
On fusionne les colonnes Intitulé_drfip avec Intitulé_shogun pour obtenir une seule colonne Intitulé
...
```
On renomme les colonnes pour savoir à quels codes les colonnes correspondent
...
- Nous allons récupérer les domaines fonctionnels : les codes contenant un tiret
...
On fusionne les deux fichiers en se basant sur la colonne Code (Code du domaine fonctionnel) 
