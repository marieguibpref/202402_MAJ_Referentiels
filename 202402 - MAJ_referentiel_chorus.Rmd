...
On modifie les noms de colonnes pour avoir les mêmes que dans la calculette
...
On fusionne les colonnes Intitulé_drfip avec Intitulé_shogun pour
obtenir une seule colonne **Intitulé** et de même pour les colonnes libellé

Règle : \
- Par défaut on prend l'intitulé de shogun car les deux sont très proches et les caractères spéciaux sont reconnus dans shogun
...
```{r}
comp_ref_prog$Libellé <- comp_ref_prog$Intitulé_shogun
...
On a à présent 36 380 référentiels de programmation alors que nous en avions seulement 13150
